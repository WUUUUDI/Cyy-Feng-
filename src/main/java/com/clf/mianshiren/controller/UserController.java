...
import com.clf.mianshiren.config.WxOpenConfig;
...
import com.clf.mianshiren.model.dto.user.UserAddRequest;
import com.clf.mianshiren.model.dto.user.UserLoginRequest;
import com.clf.mianshiren.model.dto.user.UserQueryRequest;
import com.clf.mianshiren.model.dto.user.UserRegisterRequest;
import com.clf.mianshiren.model.dto.user.UserUpdateMyRequest;
import com.clf.mianshiren.model.dto.user.UserUpdateRequest;
...
import static com.clf.mianshiren.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> addUserSignIn(HttpServletRequest request) {
        ...
        return ResultUtils.success(userService.addUserSignIn(loginUser.getId()));
    }
    ...
    public BaseResponse<List<Integer>> getUserSignInRecord(Integer year, HttpServletRequest request) {
        ...
        List<Integer> result = userService.getUserSignInRecord(year, id);
